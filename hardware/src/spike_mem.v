...
// ============================================================
// src_old/spike_buffer.v 확장: 4-bit → 128+32-bit
//
// 저장 구조:
//   l1_spikes[127:0]: L1 128뉴런 스파이크 (L2 MAC 입력으로 사용)
//   l2_spikes[ 31:0]: L2  32뉴런 스파이크 (L3 MAC 입력으로 사용)
//   L3 스파이크(2-bit)는 anomaly_judge로 직결 → 저장 불필요
//
// 쓰기: FSM이 각 뉴런 처리 후 wr_en=1로 해당 비트 갱신
// 읽기: 조합논리 (전체 버스 또는 FSM이 인덱싱)
// clear: 타임스텝 시작 전 FSM이 동기 초기화 (L3 직전 불필요)
// ============================================================
