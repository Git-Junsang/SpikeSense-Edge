// membrane_mem.v — 162뉴런 막전위 레지스터 파일 (16-bit signed)
//
// 인덱스 구조 (neuron_idx 0~161): L1 [0~127], L2 [128~159], L3 [160~161]
//
// 막전위는 타임스텝 간 유지 (SNN 누설-적분). 새 버퍼 시작 시 FSM이 rst_n으로 초기화.
// 읽기는 조합논리, 쓰기는 clk 상승 에지 + wr_en=1.
