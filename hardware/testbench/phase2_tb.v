...
// 대상: plift_core, mac_unit, weight_bram, param_rom, membrane_mem, spike_mem
//
// Vivado: 시뮬 소스에 phase2_tb.v + hardware/src/*.v 추가, top=phase2_tb.
//   weight_bram·param_rom이 $readmemh를 쓰므로 Simulation working directory를
//   프로젝트 루트로 지정할 것 (또는 Tcl: cd {/data/.../SpikeSense-Edge}).
//   그 뒤 Run Behavioral Simulation → "run all".
//
// iverilog:
...
// 3. weight_bram
// $readmemh("hardware/src/weights/w*.hex") 사용 — Vivado에선 working dir을 루트로
reg  [13:0]        wb_addr;
