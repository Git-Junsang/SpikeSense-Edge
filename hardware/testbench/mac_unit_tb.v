// mac_unit_tb.v — INT8×INT8 직렬 MAC 단독 검증
// 대상: mac_unit.v (직렬 누적, 24-bit acc)
//
// Vivado: 시뮬 소스에 mac_unit_tb.v + hardware/src/mac_unit.v 추가,
//   top을 mac_unit_tb로 두고 Run Behavioral Simulation → "run all".
...
module mac_unit_tb;
    ...
    initial begin
        ...
        // acc = 100×50 + 127×127 = 21129, current = 21129 >>> 7 = 165
        ...
        // TC2: L1 모드 — 음수 가중치 포함
        // acc = 64×32 + 64×(−32) + 64×32 = 2048, current = 2048 >>> 7 = 16
